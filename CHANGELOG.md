...
### 0000-00-00 — Template entry

- **What:** Set up the harness and initialized CLAUDE.md / CHANGELOG / TODO.
- **Why:** Project bootstrap.
- **Result:** Harness committed to repo. Conservation-law checker scaffolded but not yet wired.
- **Failed:** None this entry.
- **Next:** First fetcher (FHLB Combined Financial Report) per §18 / first-week actions.
